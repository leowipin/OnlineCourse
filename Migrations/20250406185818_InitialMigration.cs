        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    SubscriptionExpires = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Students_StudentType", "[StudentType] IN ('Standard', 'Premium')");
                    table.CheckConstraint("CK_Students_Subscription", "(([StudentType]='Premium') AND([SubscriptionExpires] IS NOT NULL) AND ([SubscriptionExpires] > [EnrollmentDate]))OR(([StudentType]<>'Premium') AND([SubscriptionExpires] IS NULL))");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CourseTagsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CoursesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Course_CourseTag", x => new { x.CourseTagsId, x.CoursesId });
                    table.ForeignKey(
                        name: "FK_Course_CourseTag_CourseTags_CourseTagsId",
                        column: x => x.CourseTagsId,
                        principalTable: "CourseTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Course_CourseTag_Courses_CoursesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Enrollments_Progress", "[ProgressPercentage] BETWEEN 0 AND 100");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    VideorUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Lessons_Duration", "([DurationSeconds] IS NULL)OR ([DurationSeconds] > 0)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Course_CourseTag_CoursesId",
                table: "Course_CourseTag",
                column: "CoursesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstructorProfiles_DeletedAt",
